...
class MoneyCollectedHandler implements DomainEventHandler
{
    /**
     * @param MoneyCollected          $domainEvent
     * @param MergePullRequestProcess $process
     */
    public function handle(DomainEvent $domainEvent, Process $process): Transition
    {
        $process        = $this->accountMoneyWasCollected($domainEvent, $process);
    ...
    private function accountMoneyWasCollected(DomainEvent $domainEvent, MergePullRequestProcess $process): MergePullRequestProcess
    {
